# **OWL’s Position Statement on Design Thinking in Schools**
...
These mindsets sit on top of OWL’s broader values \- results through integrity, transparency and trust, adaptability and iteration, collaboration, collective leadership, and learning and growth \- and translate them into everyday design habits. Borrowing from the [Stanford d.school](https://dschool.stanford.edu/) and our own extensive fieldwork using open design, we emphasize a small set of mindsets that are non-negotiable for OWL design work:
...
* **Regional & networked initiatives.** In projects like the [Western North Carolina Resilience Project](https://docs.google.com/document/d/1ucJ9Ae-9tEIEoyEBneBzCHWiX_b_gAS5pmlw1c930V8/edit?usp=sharing) (WNCRP), Together We Learn (TWL), or other regional efforts, early convenings often take the form of design labs or sprints. These gatherings help teams build shared empathy maps, draft AIM statements, and generate early change ideas that later feed into improvement science structures.
