...
As part of OWL’s commitment to open-source learning and continuous inquiry, members of our team have engaged with schools across the U.S. and internationally, including those affiliated with the [Mastery Transcript Consortium](https://mastery.org), the [Deeper Learning Network](http://www.gettingsmart.com/2017/12/model-schools-districts-networks-and-states-for-competency-based-education/), and others piloting standards-based or proficiency-based systems as a precursor to full CBE adoption.
...
OWL has also engaged in dialogue with global education thought leaders like the late David Price, OBE, an internationally respected author, consultant, and advisor to the Mastery Transcript Initiative. Price offered insight into the global landscape of CBE, describing it as “sketchy” in adoption but gaining traction in places like Finland and New Zealand. He emphasized the untapped potential of mastery-based approaches to surface skills and habits of mind that traditional transcripts overlook.

*“In a world where students are doing extraordinary things in their free time,” Price noted, “competency/mastery models make sense. There’s no limit.”*

He also pointed out that many of the world’s most forward-thinking educators and employers are seeking alternatives to GPA-driven, standardized models in favor of systems that value creativity, collaboration, and real-world problem-solving. Yet, he warned, “We only value what we measure”—a challenge CBE seeks to overcome through more meaningful, transparent documentation of learning.

### **📚 Additional Readings and Reflections**

* The Glossary of Education Reform offers a well-rounded, objective definition of [Proficiency-Based Learning](https://www.edglossary.org/proficiency-based-learning/), a common synonym or stepping stone to CBE.  
* The medical field, where CBE has long-standing roots, continues to wrestle with clarity and consistency in practice, as reflected in academic overviews like this [review in *Medical Teacher*](https://www.tandfonline.com/doi/abs/10.3109/0142159X.2010.500898).
...
* Aurora Institute. (2020). *What is Competency-Based Education?* [https://aurora-institute.org](https://aurora-institute.org)  
* CompetencyWorks. (2019). *Fit for Purpose: Taking the Long View on Systems Change and Policy to Support Competency Education*. [https://www.inacol.org/resource/fit-purpose-taking-long-view-systems-change/](https://www.inacol.org/resource/fit-purpose-taking-long-view-systems-change/)  
* Global Online Academy. (n.d.). *Competency-Based Learning Toolkit*. [https://globalonlineacademy.org/what-we-do/cbl-toolkit](https://globalonlineacademy.org/what-we-do/cbl-toolkit)

### **Rationale: Why Now?**

* EdWeek. (2020). *The Mastery vs. Seat-Time Debate Takes Center Stage Under Remote Learning*. [https://www.edweek.org/technology/the-mastery-vs-seat-time-debate-takes-center-stage-under-remote-learning/2020/11](https://www.edweek.org/technology/the-mastery-vs-seat-time-debate-takes-center-stage-under-remote-learning/2020/11)  
* Education Evolving. (2020). *Competency-Based Education: A Policy and Practice Overview*. [https://www.educationevolving.org/initiatives/competency-based-education](https://www.educationevolving.org/initiatives/competency-based-education)  
* Patrick, S. (2020). *COVID-19 as a Watershed Moment for CBE*. Aurora Institute. [https://aurora-institute.org/blog](https://aurora-institute.org/blog)

### **Learning Science and Equity**

* Rose, T. (2016). *The End of Average: How We Succeed in a World That Values Sameness*. HarperOne.  
* Khan, S. (2015). *Let’s Teach for Mastery – Not Test Scores* \[TED Talk\]. [https://www.ted.com/talks/sal\_khan\_let\_s\_teach\_for\_mastery\_not\_test\_scores](https://www.ted.com/talks/sal_khan_let_s_teach_for_mastery_not_test_scores)  
* iNACOL. (2018). *Quality Principles for Competency-Based Education*. [https://www.inacol.org/resource/quality-principles-for-competency-based-education/](https://www.inacol.org/resource/quality-principles-for-competency-based-education/)  
* CompetencyWorks. (2018). *Introducing an Equity Framework for Competency Education*. [https://www.competencyworks.org](https://www.competencyworks.org)

### **Practice-Based Examples and Case Studies**

* Edutopia. (2020). *Assessing Learning Without Tests*. [https://www.edutopia.org/article/assessing-learning-without-test](https://www.edutopia.org/article/assessing-learning-without-test)  
* Getting Smart. (2020). *Show What You Know: A Landscape Report on CBE*. XQ Institute. [https://xqsuperschool.org/competency-based-education-cbe/part1](https://xqsuperschool.org/competency-based-education-cbe/part1)  
* GOA. (2020). *How to Write a Competency: Six Steps for Educators*. [https://globalonlineacademy.org/insights/articles/how-to-write-a-competency-six-steps-for-educators](https://globalonlineacademy.org/insights/articles/how-to-write-a-competency-six-steps-for-educators)  
* Mastery Transcript Consortium. (n.d.). [https://mastery.org](https://mastery.org)

### **Systemic Challenges & Policy Levers**

* Education Commission of the States. (2020). *Seat Time vs. Mastery: Policy Flexibilities and Barriers*. [https://www.ecs.org](https://www.ecs.org)  
* Minnesota Statute 126C.05. *Educational Revenue and Attendance Reporting*. [https://www.revisor.mn.gov/statutes/cite/126C.05](https://www.revisor.mn.gov/statutes/cite/126C.05)  
* FutureEd. (2020). *Testing Blueprints: Reimagining Assessment Systems*. [https://www.future-ed.org](https://www.future-ed.org)

### **Cultural Shifts and Design Implications**

* OECD. (2015). *Schooling Redesigned: Towards Innovative Learning Systems*. [https://www.oecd-ilibrary.org/education/schooling-redesigned\_9789264245914-en](https://www.oecd-ilibrary.org/education/schooling-redesigned_9789264245914-en)  
* IDEO. (n.d.). *Design Thinking for Educators Toolkit*. [https://designthinkingforeducators.com](https://designthinkingforeducators.com)  
* EL Education. (n.d.). *Leaders of Their Own Learning: Transforming Schools Through Student-Engaged Assessment*. [https://eleducation.org/resources/leaders-of-their-own-learning](https://eleducation.org/resources/leaders-of-their-own-learning)

### **Real-World Alignment**

* Udacity. (n.d.). *Nanodegree Programs*. [https://www.udacity.com/nanodegree](https://www.udacity.com/nanodegree)  
* Coursera. (n.d.). *Top Specializations & Certificates*. [https://www.coursera.org/featured/top\_specializations\_locale\_en\_os\_web](https://www.coursera.org/featured/top_specializations_locale_en_os_web)
