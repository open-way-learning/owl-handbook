...
What’s usually missing is a way to learn, together, from what we try \- so that good ideas become reliable practices instead of one more thing on the pile. Improvement Science offers that sort of disciplined learning process; Networked Improvement Communities (NICs) give it a home. Together, they help schools and districts “get better at getting better,” not just run the next program (Reference: [Learning to Improve, Bryk, et al)](https://www.carnegiefoundation.org/improvement-products-and-services/articles/learning-to-improve/?utm_source=chatgpt.com)
...
* A **Networked Improvement Community (NIC)** is a group of teams who:  
  ...
  * Learn together across contexts, so that what works in one place can be adapted \- not cloned \- somewhere else. (Reference: [Why a NIC?, Paul LeMahieu](https://www.carnegiefoundation.org/improvement-products-and-services/articles/why-a-nic/?utm_source=chatgpt.com))
