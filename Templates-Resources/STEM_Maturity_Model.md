...
### **1\. [STEM Maturity Model Rubric (Google Sheet)](https://docs.google.com/spreadsheets/d/1IQIOX3n0nE9wl_Zr8_FGLWMrZX8p7So_FMOEM4Xb9oo/edit?usp=sharing)**
...
Rather than scoring yourself on a long scale, you compare your current reality against a clear description of strong practice and then define concrete steps to close the gap. Many teams also use the rubric to generate simple [radar charts](https://en.wikipedia.org/wiki/Radar_chart) that visualize strengths and growth areas across the seven elements.
...
* [Science & Engineering Practices (SEP) mastery rubrics](https://docs.google.com/document/u/0/d/1_365sxIQjenq4i-icO_V_FZ6WtD1B3muDuASGLKZjRg/edit)  
* [STEM growth mindset rubrics](https://docs.google.com/spreadsheets/u/0/d/10tChc9R2ixIw1DvZxP5WRhCvpmpqKQXAtHcBbhw6aPc/edit)  
* Improvement Science tools such as Aim Statements, [Driver Diagrams](https://docs.google.com/presentation/u/0/d/1TVR3L7H2D7kFJGyix9CeG-LPweBHiy08YFGuG5wpkZg/edit), and PDSA cycles  
* [STEM/makerspace planning templates](https://docs.google.com/document/u/0/d/1peOHTC8Tuw3V_APHBE7oQmF2z5xCd-zcAaOlHFl-aP8/edit) and [workshop resources](https://docs.google.com/document/u/0/d/1KWHQcoDqygBUljf4OOFmMlNbYS-n5wwSDhO7FaaHGto/edit)  
* [OWL’s Makerspace Roadmap](https://docs.google.com/spreadsheets/d/1iV0Hlrw0T7_ejWdEi3iM8pPHY-dQb3Ntz0xYNlkD4LU/edit?usp=sharing) and [Dream Makerspace](https://docs.google.com/spreadsheets/d/1-6-pC8WK-6dCJkAGnE1WjscvxuDMI2mh_rtlggWy3lM/edit?usp=sharing)
...
* The [Maturity Model for Student Success](https://docs.google.com/document/u/0/d/1KmKnKEuCEK5qTEmQnCfJ-drDPNgTZl0zGqQfLReeUfo/edit) focuses on what all students directly experience across subjects: a felt sense of safety and belonging, opportunities for deep, meaningful learning, and high-quality facilitation that builds agency and independence.

* The [Maturity Model for Learner-Centered Innovation](https://docs.google.com/document/u/0/d/1dLRK1SvLPLFYluzVrLNzqGev8jjUjBWBnPVfdCJzrIE/edit) sits one level “upstream.” It focuses on the culture-level systems and conditions \- innovation ethos, open-source sharing, radical collaboration, collective leadership, and a living mission & vision \- that make student-level practices possible and sustainable.
...
- [ ] Use the [STEM Growth Mindset single-point rubric](https://docs.google.com/spreadsheets/u/0/d/10tChc9R2ixIw1DvZxP5WRhCvpmpqKQXAtHcBbhw6aPc/edit) with one class or grade level as a reflection tool during or after a major STEM challenge.
...
- [ ] Pilot the [SEP Mastery Rubric](https://docs.google.com/document/u/0/d/1_365sxIQjenq4i-icO_V_FZ6WtD1B3muDuASGLKZjRg/edit) as part of a Show & Explain assessment at the end of a project or lab.
