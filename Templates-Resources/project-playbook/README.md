...
* Gather artifacts and lived experience to inform empathy work\
  ✅ **Core Output**: Pre-work insights to bring into onboarding\
  📂 Suggested Tools: Student quotes, empathy interviews, early data trends
...
* Begin sketching a Driver Diagram prototype\
  ✅ **Core Output**: Draft AIM + Initial Change Ideas + Empathy Summary\
  📂 Suggested Tools: Empathy Map Template, Insight Carousel Protocol, AIM Litmus Test
...
*   Revisit and strengthen the AIM Statement based on what is learned
    ...
    ✅ **Core Output**: Validated Problem Statement + Refined AIM\
    📂 Suggested Tools: Student Voice Protocols, Problem Statement Builder, AIM Reflection Prompts
...
* Develop a Driver Diagram as your team’s theory of improvement\
  ✅ **Core Output**: SMART AIM + Completed Driver Diagram\
  📂 Suggested Tools: Driver Diagram Template, Value/Effort Matrix, Change Idea Prioritization Tool\
  &#xNAN;_&#x4E;ote: This module is introduced during the first school visit but often takes multiple sessions to complete. A solid Driver Diagram reflects shared understanding and readiness to test early ideas._
...
* Rinse, repeat.\
  ✅ **Core Output**: First PDSA Cycle Plan + Learning Measures\
  📂 Suggested Tools: PDSA Planner, Learning Tracker, Measurement Table

### **Key Tools & References Used Throughout the Playbook**

_All tools referenced in the Playbook are optional and adaptable. Use what serves your team, and feel free to work with project partners to remix or substitute based on local needs._

* [Equity Meets Design: The Problem with Problems Rubric – Creative Reaction Lab](https://courses.equitymeetsdesign.com/p/the-problem-with-problems)
* [Process vs. Outcome Evaluation Summary](https://tsne.org/blog/process-evaluation-vs-outcome-evaluation/)
* [Define Stage – Design Thinking – Interaction Design Foundation](https://www.interaction-design.org/literature/article/stage-2-in-the-design-thinking-process-define-the-problem-and-interpret-the-results)
* [Future Protocol (Back to the Future) – (CLEE)](https://www.clee.org/resources/virtual-back-to-the-future-protocol/)
* [Learning to Improve: How America’s Schools Can Get Better at Getting Better – Bryk et al.](https://www.carnegiefoundation.org/resources/publications/learning-to-improve/)

_Note that other tools are referenced in each Module or the Innovation Blueprint._
...
_**“Start small. Learn fast. Stay grounded in what matters most.”**_
