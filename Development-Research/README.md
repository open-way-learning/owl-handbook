...
- **Grants & Proposals:** Lead narrative, budget coordination (with DFIO), compliance attachments, and submission.
...
When serving as PM for non-WNCRP work, **earn your keep**: cover salary (and attributable overhead) **monthly** through billable service and/or funded grants/contracts in your portfolio.

## RACI-S snapshot (common calls)
- **Grant/Proposal Submission:** **A = DPD**, R = DPD, C = DFIO/D-OSL/DPIV, I = Team (Board if material).
- **Strategic Partnership (MOU):** **A = DPD**, R = DPD, C = DFIO (terms/compliance), D-OSL (mission/precedent), DPIV (program/brand), I = Team/Board if material.
...
3) Tag **DPD (owner)** + **D-OSL (steward)** for review; merge after approval.  
