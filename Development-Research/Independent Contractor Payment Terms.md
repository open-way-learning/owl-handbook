...
This procedure outlines OWL’s guiding approach to ensure fair, transparent, and mission-aligned compensation for consultants, including those invited through the OWL Fellowship program. It is designed to support consistency in how we evaluate and compensate contracted services, especially those helping schools and districts scale learner-centered innovation.

Importantly, this procedure is not a rigid policy. It provides a flexible framework that supports thoughtful, case-by-case decisions based on the nature of the work, the consultant’s qualifications, and the project’s funding context. The goal is to balance clarity with adaptability—ensuring alignment to OWL’s values while allowing for professional discretion and mutual agreement.

## **Core Compensation Principles**

1. **Fairness & Equity:** Pay reflects a consultant’s experience, competency, and contribution—across all identities and backgrounds.

2. **Transparency & Advancement:** Clear guidance for how to earn, maintain, and progress through consultant tiers.

3. **Sustainability:** OWL retains 20–25% of client revenue to support core operations. Consultant rates are derived accordingly and do not match market consulting rates dollar-for-dollar.
...
| ----- | ----- | ----- | ----- |
| **1** | Associate Consultant | $40–$60/hr | Emerging practitioner; supports delivery; limited OWL experience |
| **2** | Core Consultant | $60–$90/hr | Delivers content; growing competency; 1–2 prior OWL engagements |
| **3** | Senior Consultant | $90–$125/hr | Leads engagements; OWL Fellow or repeat contractor; strong competencies |
| **4** | Strategic/Expert Lead | $125–$140+/hr | High-demand expert; national presence; models full OWL competency spectrum |

*Note that all rates are subject to final approval based on project scope and funding availability.*

## **Consultant Tier Rubric (Out of 40 Points)**

This scoring system evaluates readiness and advancement based on:

| Dimension | Criteria | Max Points |
| ----- | ----- | ----- |
| **Education Experience** | K–12/classroom/system leadership (1 pt/year) | 10 |
| **Adult Learning / PD Experience** | PD design, coaching, facilitation (2 pts/year) | 10 |
| **OWL-Specific Experience** | OWL Fellow (5), Ambassador (2), past projects (1–3 each), tool or curriculum co-design (up to 5\) | 10 |
| **Competency Proficiency** | Based on OWL’s 6 domains (coaching, facilitation, pedagogy, philosophy, communication, leadership) | 10 |
