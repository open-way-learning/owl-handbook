...
**Version:** 0.1 (Draft)  
**Owner:** Director of Programs & Impact Visibility (DPIV) – with input from all Directors  
...
1. Log the potential partner in OWL’s CRM and internal planning board.  
2. Use the [Partner Intake Framework](https://docs.google.com/document/u/0/d/1TJstFioOfu70tVvPMix5IFPCqwcAgG2pCiHtL3tt6CM/edit)\* and OWL’s Core Partnership Guardrails (Appendix D) to assess the following:  
...
3. Share OWL’s framing documents (e.g. *“Our Approach,” GitBook links, project examples*)   
4. If appropriate, begin a draft “Gives & Gets” Matrix (Appendix C) to clarify anticipated contributions and mutual benefits.
...
Use the [Discovery Call Template](https://docs.google.com/document/u/0/d/1Us3iqpBnAUGwCOfnKlZBq9Vq6RHn2MUIMkI7_XOpVp0/edit) to guide early conversations. Like the intake process, we typically use this template to guide conversations with schools and districts, but it can be adapted in this case to help surface shared priorities and test alignment for a potential partnership. Please view this as a co-learning tool and not a checklist, with the goal of designing something collaboratively, assuming the fit feels right for both parties.
...
- [ ] **Go:** Move forward into scoping, co-design, and MOU development.  
- [ ] **Pause/More Info Needed:** Re-engage for clarification or defer to a later time based on readiness or context.  
- [ ] **No-Go:** Politely decline or redirect, citing misalignment, limited capacity, or scope mismatch.
...
| Element | MOU | SOW |
| ----- | ----- | ----- |
| **Purpose** | Formalize partnership & shared intent | MOU items plus more defined specific actions and deliverables |
| **Focus** | Relationship & mutual commitment | MOU items plus more detail regarding tactical execution over time |
| **Structure** | General roles, goals, and principles | MOU items plus detailed tasks, timelines, people, etc. |
| **Used When** | Most single-partnership arrangements  | Complex/multi-phase work, subgrants, external deadlines, high visibility initiatives, or projects \>$100k |
...
* Use real-time project dashboards or shared folders to increase transparency (reference [OWL’s Rethinking Measures of Success](https://docs.google.com/document/d/1xaIBkxRmtb6MhSKCWoZbGSVyS44dksY8KId4F-1TvRw/edit?usp=sharing) document for details).  
...
- [ ] **Extend or renew** with a revised scope or updated roles  
- [ ] **Pause** the partnership with an agreement to reassess in the future  
- [ ] **Sunset** the relationship with gratitude, learning, and closure
...
| Guardrail | What this Means |
| ----- | ----- |
| Mission Alignment | Alignment with OWL’s learner-centered, equity-driven mission, vision, and values. |
| Co-Design Over Control | Evidence that the partner approaches work with schools with humility and a collaborative posture, not prescriptive models. All scopes and roles adapt to local school context and readiness. |
| Nonprofit-Led Structure | Strategic narrative, design, and decisions led by OWL or Primary Partners that have a mission-driven motivation, not a profit-driven motive. |
| Transparency with Schools | All school-facing relationships are clearly co-managed to prevent confusion or overreach. |
| Role-Specific Visibility | Branding and attribution must reflect each partner’s actual contributions. |
| Scope Documentation | Each partner has a clear understanding of their role, responsibility, and scope of work. |
...
| Partner | Gives (Contributions) | Gets (Benefits) |
| :---- | :---- | :---- |
...
| ----- | ----- |
| “What is your organization hoping OWL can help deliver?” | “What shared goals might our organizations pursue more effectively together?” |
| “Who are the key decision-makers for this engagement?” | “Who on your team would help guide this collaboration if we move forward?” |
| “What is your timeline for launching this engagement?” | “Are there any upcoming opportunities or planning cycles we should be aware of?” |
