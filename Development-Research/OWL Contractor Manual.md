...
* Exceptions to this policy (e.g. for joint grant-funded work or multi-organization partnerships, etc.) may be approved in writing by OWL leadership in advance.
...
* **Self-Evaluation:**  
   Candidates complete the **OWL Fellow Competency Rubric**, a reflective tool that informs both their personal development and initial Tier placement within OWL’s compensation framework.
...
* Onboarding materials, including:  
  ...
  * OWL Code of Ethics  
  * OWL Fellow Competency Framework  
  * Invoice Template and Sample Scope of Work (SOW)  
  * “About OWL – The What & How” overview
...
* **Shadow an OWL Workshop:** Observe a half- or full-day OWL-led engagement to gain insight into facilitation strategies, client culture, and participant interaction. *Note:*   
   *Travel expenses are reimbursed; however, observation time is not compensated.*
...
* OWL Fellows are not employees and will be compensated on a per-project basis under a 1099 structure.  
...
* **Co-Design Planning:** At least one week before service, OWL will convene a planning session to verify the following (aligned to the “[5P rule](https://www.nhbr.com/advertisement-the-rule-of-5ps/)”):  
